...
title: Deploy on Fly.io | Deployment | Deploy SurrealDB | Fly.io
...
[Fly.io](https://fly.io/) is a platform that allows you to deploy your applications globally. It provides a simple and easy-to-use interface to deploy your applications. In this deployment guide, we will guide you through the process of deploying SurrealDB on Fly.io.
